...
`;
  ...
  return (
    <RecommendedContainer>
      <TitleSection>Recommended</TitleSection>
      ...
      <Carousel
        ...
        loop
      >
        {props.data.included[2].attributes.contents.map((card, i) => {
          return (
            <Carousel.Item key={i}>
              <Card key={i}>
                <h3 style={{ display: "none" }}>{i + 200}</h3>
                <TopDiv>
                  <TopLeftDiv>
                ...
                <MiddleDiv>
                  <DetailDiv>
                    ...
                    <Snippet>{card.snippet.substr(0, 140)}...</Snippet>
                  </DetailDiv>
                  <div
                    style={{ display: "flex", width: "100%", marginTop: "5px" }}
                  >
                    {card.tags.map((tags, i) => {
                      return <Tags key={i}>{tags.name}</Tags>;
                    })}
                  </div>
                </MiddleDiv>
