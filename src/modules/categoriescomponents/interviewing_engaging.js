    ...
    >
      {!props.loading ? (
        <div>
          <InterviewSection>
            <TitleDiv>
              {props.interviewingGetData.data.attributes.title}
            </TitleDiv>
            <Intro>{props.interviewingGetData.data.attributes.intro}</Intro>
          </InterviewSection>
          <CardDiv>
            {props.interviewingGetData.included[0].attributes.contents.map(
              (card, i) => {
                return (
                  <Card>
                    <h3 style={{ display: "none" }}>{i + 400}</h3>
                    <TopDiv>
                      <TopLeftDiv>
